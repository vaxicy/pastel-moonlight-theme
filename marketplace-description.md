...
A soft, modern pastel pink VS Code theme for creative developers. Dreamy, minimal, easy on the eyes.
...
- 🧠 Semantic highlighting for accurate, modern token coloring
- 🦄 Optimized for JavaScript, TypeScript, React, HTML, CSS, JSON, Python, Markdown

### Perfect for

Frontend Developers · Designers · AI Builders · Creative Programmers

Install, switch with `Ctrl/Cmd+K Ctrl/Cmd+T`, and enjoy a cozy creative coding space.
